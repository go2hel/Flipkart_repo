...
import com.sample.service.CustomerOperation;
...
public class CustomerMenu {
    ...
    public void MainMenu(){
        ...
        try {
            approved = UserOperation.getInstance().isApproved(custID);
        } catch (Exception e) {
    ...
    private void viewItems(){
        List<Item> itemList = CustomerOperation.getInstance().viewItems();
    ...
    private void viewCart(){
        List<Item> itemList = CustomerOperation.getInstance().viewCart(custID);
        if(itemList.isEmpty()){
    ...
    private void addItem(){
        ...
        try {
            CustomerOperation.getInstance().addItem(custID,name,count);
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
    }
    ...
    private void removeItem(){
        ...
        try {
            CustomerOperation.getInstance().removeItem(custID,name);
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
    }
    ...
    private void viewBalance(){
        System.out.println();
        float balance = CustomerOperation.getInstance().viewBalance(custID);
    ...
    private void addViaCard(float amount, ModeOfPayment modeOfPayment){
        ...
        CustomerOperation.getInstance().addMoney(custID,amount,modeOfPayment);
    }
    ...
    private void addViaUPI(float amount){
        ...
        CustomerOperation.getInstance().addMoney(custID,amount,ModeOfPayment.UPI);
    }
